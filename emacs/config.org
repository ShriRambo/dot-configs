...
Example ticket [[jira:IT-1321]] and bitbucket repo [[bibu:streaming-transforms/src/master]]
...
(org-link-set-parameters "bibu"
    ;; When you click on such links, take you to jira ticket
    :follow (lambda (label) (browse-url (concat "https://bitbucket.org/northpool/" label)))
   ;:display 'full
   ;; Show Jira links in green
